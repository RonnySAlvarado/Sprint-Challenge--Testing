...
Describe() groups several related tests into a "suite". Describe is optional.

It() will be what will be evaluated.

2. What is the point of `Test Driven Development`? What do you think about this approach?

Test Driven Development is making the tests firsts and then writing code to make those tests pass rather than
writing your code out and then writing the tests to see if they pass. Ultimately, it's supposed to make it 
